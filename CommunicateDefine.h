...
#define CLEAR_SERVO_QUEUE                  0X05
#define CLEAR_SERVO_QUEUE_LEN              2

#define ASYN_OR_SYNC                       0X06
#define ASYN_OR_SYNC_LEN                   2
#define ASYN_OR_SYNC_RETURN_LEN            3
...
#define    SET_ELETRIC_GRIPPER             0x6B
#define    SET_ELETRIC_GRIPPER_LEN         3

#define    INIT_ELETRIC_GRIPPER            0x6C
#define    INIT_ELETRIC_GRIPPER_LEN        2

#define    SET_GRIPPER_MODE                0x6D
#define    SET_GRIPPER_MODE_LEN            3

#define    GET_GRIPPER_MODE                0x6E
#define    GET_GRIPPER_MODE_LEN           2
#define    GET_GRIPPER_MODE_RETURN_LEN    3
...
#define GET_SERVO_LAST_PDI                0xe6
#define GET_SERVO_LAST_PDI_LEN               3
#define GET_SERVO_LAST_PDI_RETURN_LEN        6
