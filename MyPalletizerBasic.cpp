...
/*#if defined MyCobot_M5
            ...
            switch (int(r_data_3[0])) {
                ...
                case IS_FREE_MOVE_MODE: {
                    bool *pIsFreeMove = new bool;
                    *pIsFreeMove = bool(r_data_3[1]);
                    return pIsFreeMove;
                }
                case GET_SERVO_DATA: {
...
void MyPalletizerBasic::releaseAllServos()
{
    mycobot_serial.write(header);
    mycobot_serial.write(header);
...
void MyPalletizerBasic::setFreeMoveMode(bool mode)
{
    mycobot_serial.write(header);
    mycobot_serial.write(header);
...
bool MyPalletizerBasic::isFreeMoveMode()
{
    mycobot_serial.write(header);
    mycobot_serial.write(header);
